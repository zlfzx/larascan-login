    ...
    <x-slot name="script">
        <script>
            ...
            if (!('BarcodeDetector' in window)) {
                ...
                main.innerHTML = '<h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">Browser tidak support BarcodeDetecor!</h2>'
            }
            else {
                // video element
